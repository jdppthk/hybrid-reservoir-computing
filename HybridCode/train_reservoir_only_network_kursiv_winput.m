function HESN = train_reservoir_only_network_kursiv_winput(input,output,beta,HESN,NetArgs)
...
%% Calculate the results of the reservoir-only system with feedforward 
% input for this set of data
